function [R_S_3D] = Laue_temp_Gui_par_3D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,ky_array,kx_array)
...
% 
% G_0H_S_3D = fftshift(fftshift(fftshift(fftn(R_S_3D),1),2),3);
