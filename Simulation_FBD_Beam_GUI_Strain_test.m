function Simulation_FBD_Beam_GUI_Strain_test
...
h.Element = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.06 0.8 0.03 0.1],...
    'String','C',...
    'FontSize',Font_size);
h.name_a_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.09 0.8 0.015 0.1],...
    'String','a',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',Font_size);
h.a_parameter = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.105 0.8 0.035 0.1],...
    'String','3.568',...
    'FontSize',Font_size);
h.name_b_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.14 0.8 0.015 0.1],...
    'String','b',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',Font_size);
h.b_parameter = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.155 0.8 0.035 0.1],...
    'String','3.568',...
    'FontSize',Font_size);
h.name_c_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.19 0.8 0.015 0.1],...
    'String','c',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',Font_size);
...
h.Absorption =  uicontrol('Parent',h.lp_fit,...
    ...
    'Callback',@Bragg_Fit_Check,...
    'Units','Normalized',...
    'Position', [0.045 0.7 0.045 0.1]);

h.name_alpha_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.09 0.7 0.015 0.1],...
    'String','a',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontName','symbol',...
    'FontSize',Font_size);
h.alpha_parameter = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.105 0.7 0.035 0.1],...
    'String','90',...
    'FontSize',Font_size);
h.name_beta_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.14 0.7 0.015 0.1],...
    'String','b',...
    'FontName','symbol',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',Font_size);
h.beta_parameter = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.155 0.7 0.035 0.1],...
    'String','90',...
    'FontSize',Font_size);
h.name_gamma_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.19 0.7 0.015 0.1],...
    'String','c',...
    'FontName','symbol',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',Font_size);
...
h.Strain_Crystal = uicontrol('Parent',h.lp_fit,...
    'Style','push',...
    'Units','normalized',...
    'Position',[0.87 0.6 0.07 0.1],...
    'String','Strain crystals',...
    'BackgroundColor',[0 0.95 0.95],...
    'FontSize',Font_size,...
...
h.Polarization_p_Mono =  uicontrol('Parent',h.lp_fit,...
    ...
    'Callback',@Beam_3D_plot,...
    'Units','Normalized',...
    'Position', [0.41 0.05 0.035 0.1]);


h.name_Thickness_Mono =uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.445 0.05 0.029 0.1],...
    'BackgroundColor',[0.45 0.45 0.45],...
    'String','T(um)',...
    'FontSize',Font_size-2);

h.Thickness_Mono =uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.474 0.05 0.04 0.1],...
    'BackgroundColor',[0.45 0.45 0.45],...
    'String','1e3',...
    'FontSize',Font_size-2);
...
h.Gaussian_Beam_SASE_Check =  uicontrol('Parent',h.lp_fit,...
    ...
    'Callback',@Beam_3D_plot,...
    'Units','Normalized',...
    'Position', [0.67 0.45 0.05 0.1]);

h.name_rhoparameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.72 0.45 0.01 0.1],...
    'String','r',...
    'BackgroundColor',[0.4 0.4 0.4],...
    'FontSize',Font_size-2,...
    'FontWeight','bold',...
    ...
    function Dynamical_Reflectivity(source,evendata)
        if source == h.Dynamical_Theory_Plots
            ...
            set(h.I_Fig_Reflectivity_Dynamical,'Name','Dynamical reflectivity',...
                ...
                'visible','on',...
                'Units','normalized',...
                'Position', [Position_x Position_y-(width_y+0.1) width_x width_y+0.05],...
                'Color',[0.8 0.8 0.8],...
                'Menubar','none',...
                'KeyReleaseFcn',@Press);
        ...
        elseif source == h.Dynamical_Reflectivity
            ...
            [Z, F0,FH,F_H,a_Par,b_Par,c_Par,alpha_Par,beta_Par,gamma_Par] = Element_Bragg_temp_Gui_10092018(element,h_Miller, k_Miller, l_Miller, Energy_Bragg);
            ...
            set(h.alpha_parameter,'String',alpha_Par)
            set(h.beta_parameter,'String',beta_Par)
            set(h.gamma_parameter,'String',gamma_Par)
            ...
            if get(h.Bragg_Check,'Value')
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_0H_S,E_Scan,G_0H,t_array,k_array,Dwidth] = Bragg_temp_Gui_test(a_Par,b_Par,c_Par,Energy_Bragg,Energy_center,h_Miller,k_Miller,l_Miller,DWF,F0,FH,F_H,Absorption,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Steps,get(h.Bragg_FBD_Check,'Value'),crystal_orientation);
            ...
            elseif get(h.Bragg_FBD_Check,'Value')
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_00_S,E_Scan,G_00,t_array,k_array,Dwidth] = Bragg_temp_Gui_test(a_Par,b_Par,c_Par,Energy_Bragg,Energy_center,h_Miller,k_Miller,l_Miller,DWF,F0,FH,F_H,Absorption,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Steps,get(h.Bragg_FBD_Check,'Value'),crystal_orientation);
                ...
                hold on
                plot(E_Scan,abs(R_00_S).^2, 'Parent',h.I_Fig_Reflectivity_In)
                title('Reflectivity Bragg vs Energy')
                xlabel('Energy (eV)')
                axis auto
                if get(h.name_lim_K_Space_center,'value') == 1
            ...
            elseif get(h.Laue_FBD_Check,'Value')
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_0H_S,R_00_S,E_Scan,G_00,G_0H,t_array,t_max0,x_transvers_array,X_max0,Dwidth] = Laue_temp_Gui_1D_test(a_Par,b_Par,c_Par,Energy_Bragg,Energy_center,h_Miller,k_Miller,l_Miller,DWF,F0,FH,F_H,Absorption,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Steps,get(h.Bragg_FBD_Check,'Value'),crystal_orientation);
    ...
    function Beam_3D_plot (source,eventata)
        ...
        if source == h.Beam_simulation_Plots
            ...
            set(h.I_Fig_3D_Reflectivity_Dynamical,'Name','Dynamical Reflectivity Beam',...
                ...
                'visible','on',...
                'Units','normalized',...
                'Position', [Position_x+0.6 0.1 width_x 1],...
                'Color',[0.8 0.8 0.8],...
                'Menubar','none',...
                'KeyReleaseFcn',@Press);
    ...
    function Beam_3D_Reflectivity(source,eventdata)
        ...
        if get(h.More_Crystal_Chk,'value') == 1
            if Geometry_MCC(1,i_cryst_show) ==1 
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,G_S,t_array,k_array,Dwidth] = Bragg_temp_Gui_test(a_Par(1,i_cryst_show),b_Par(1,i_cryst_show),c_Par(1,i_cryst_show),Energy_center,Energy_center,h_MCC(1,i_cryst_show),k_MCC(1,i_cryst_show),l_MCC(1,i_cryst_show),DWF,F0(1,i_cryst_show),FH(1,i_cryst_show),F_H(1,i_cryst_show),absor,Range_E_neg,Range_E_pos,polarization_MCC(1,i_cryst_show),Asymmetry_MCC(1,i_cryst_show),Thickness_MCC(1,i_cryst_show),N_Step,Transmission_MCC(1,i_cryst_show),Normal_MCC(1,i_cryst_show));
                set(h.Chi_0,'String',Chi_0_Cx)
                set(h.Chi_h,'String',Chi_h_Cx)
                set(h.Theta_view,'String',Theta_Bragg*180/pi)
                set(h.DarwinWidth,'string',Dwidth)                
                ...
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,t_array,k_array,Dwidth] = Laue_temp_Gui_test(a_Par(1,i_cryst_show),b_Par(1,i_cryst_show),c_Par(1,i_cryst_show),Energy_center,Energy_center,h_MCC(1,i_cryst_show),k_MCC(1,i_cryst_show),l_MCC(1,i_cryst_show),DWF,F0(1,i_cryst_show),FH(1,i_cryst_show),F_H(1,i_cryst_show),absor,Range_E_neg,Range_E_pos,polarization_MCC(1,i_cryst_show),Asymmetry_MCC(1,i_cryst_show),Thickness_MCC(1,i_cryst_show),N_Step,Transmission_MCC(1,i_cryst_show),Normal_MCC(1,i_cryst_show));
                set(h.Chi_0,'String',Chi_0_Cx)
                set(h.Chi_h,'String',Chi_h_Cx)
                set(h.Theta_view,'String',Theta_Bragg*180/pi)
                %set(h.DarwinWidth,'string',Dwidth)
            ...
            if get(h.Bragg_Check,'Value') ==1 ||  get(h.Bragg_FBD_Check,'Value') == 1
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,G_S,t_array,k_array,Dwidth] = Bragg_temp_Gui_test(a_Par(1,1),b_Par(1,1),c_Par(1,1),Energy_center,Energy_center,h_Miller(1,1),k_Miller(1,1),l_Miller(1,1),DWF,F0(1,1),FH(1,1),F_H(1,1),absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,get(h.Bragg_FBD_Check,'Value'),crystal_orientation);
                set(h.Chi_0,'String',Chi_0_Cx)
                set(h.Chi_h,'String',Chi_h_Cx)
                set(h.Theta_view,'String',Theta_Bragg*180/pi)
                set(h.DarwinWidth,'string',Dwidth)
            ...
            elseif get(h.Laue_FBD_Check,'Value')  == 1 || get(h.Laue_Check,'Value') == 1
                [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,R_00,E_Scan,G_S,G_0H,t_array,t_max0,x_transvers_array,xmax_0,Dwidth] = Laue_temp_Gui_1D_test(a_Par(1,1),b_Par(1,1),c_Par(1,1),Energy_center,Energy_center,h_Miller(1,1),k_Miller(1,1),l_Miller(1,1),DWF,F0(1,1),FH(1,1),F_H(1,1),absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,get(h.Laue_FBD_Check,'Value'),crystal_orientation);
                set(h.Chi_0,'String',Chi_0_Cx)
                set(h.Chi_h,'String',Chi_h_Cx)
                set(h.Theta_view,'String',Theta_Bragg*180/pi)
                %set(h.DarwinWidth,'string',Dwidth)
...
%                 pause(0.1)
                ...
                if get(h.More_Crystal_Chk,'value') == 1
                    ...
                    for i_cryst = 1:size(pos_MCC,2)
                        ...
                        if pos_MCC(1,i_cryst) == 1 
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D1] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                LaueD = 0;
                            else
                                [R_S_3D1] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                LaueD = 1;
                            end
                        ...
                        elseif pos_MCC(1,i_cryst) == 2                             
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D2] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D2] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 3                            
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D3] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D3] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                         ...
                         elseif pos_MCC(1,i_cryst) == 4
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D4] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                               
                            else
                                [R_S_3D4] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                           ...
                           elseif pos_MCC(1,i_cryst) == 5
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D5] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D5] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 6
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D6] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D6] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 7
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D7] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D7] = Laue_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 8
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D8] = Bragg_temp_Gui_3D_test(a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,F0(1,i_cryst),FH(1,i_cryst),F_H(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                    ...
                    %Calculate the Green function using Kx and K
                    if get(h.Bragg_Check,'Value') ==1 || get(h.Bragg_FBD_Check,'Value') == 1
                        [R_S_3D1] = Bragg_temp_Gui_3D_test(a_Par,b_Par,c_Par,Energy_center,Energy_center,h_Miller,k_Miller,l_Miller,DWF,F0,FH,F_H,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array,crystal_orientation);
                        LaueD = 0;
                        
                    elseif get(h.Laue_Check,'Value') ==1 || get(h.Laue_FBD_Check,'Value') == 1
                        [R_S_3D1] = Laue_temp_Gui_3D_test(a_Par,b_Par,c_Par,Energy_center,Energy_center,h_Miller,k_Miller,l_Miller,DWF,F0,FH,F_H,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array,crystal_orientation);
                        LaueD = 1;
            ...
            for i_steps = 1: number_Steps + 1
                ...
                if get(h.Mono_Beam_Check,'Value') == 1
                    ...
                    [Z_Mono,F0_Mono,FH_Mono,F_H_Mono,a_Par_Mono,b_Par_Mono,c_Par_Mono,alpha_Par_Mono,beta_Par_Mono,gamma_Par_Mono]=Element_Bragg_temp_Gui_10092018(element_Mono,h_Miller_Mono,k_Miller_Mono,l_Miller_Mono,Energy_Bragg);
                    ...
                    [Theta_Bragg_Mono,Chi_0_Cx_Mono,Chi_h_Cx_Mono,R_0H_S_Mono,E_Scan,G_S,t_array,k_array,Dwidth] = Bragg_temp_Gui_test(a_Par_Mono,b_Par_Mono,c_Par_Mono,Energy_Bragg,Energy_center,h_Miller_Mono,k_Miller_Mono,l_Miller_Mono,DWF,F0_Mono,FH_Mono,F_H_Mono,absor,Range_E_neg,Range_E_pos,Polarization_Mono,Ang_asy_Deg_Mono,Thickness_Mono,N_Step,0,crystal_orientation_Mono);
...
%                     % Gaussian_K=(fft(Gaussian_T));
                ...
                save_folder_intermediate = '/Users/angrod/Desktop/Strain FBD/FBD-sim-Analysis/gitlab/Temporal_Data';
