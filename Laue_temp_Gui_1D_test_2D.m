function [Theta_Bragg_Asy,Chi_0_Cx,Chi_h_Cx,R_0H_S,E_Scan_plot,G_0H,t_array,Dwidth] = Laue_temp_Gui_1D_test_2D(a_Par,b_Par,c_Par,Energy_Bragg,Energy_center,h_Miller,k_Miller,l_Miller,DWF,F0,FH,F_H,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,crystal_orientation)
%%% Calculations
% Constants
