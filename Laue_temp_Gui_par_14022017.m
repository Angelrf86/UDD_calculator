function [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,t_array,k_array]= Laue_temp_Gui_par_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD)
...
I_0H_Smax = 0;
for i_Gmax = 1:N_Step
    if I_0H_Smax < I_S(1, i_Gmax)
       I_0H_Smax = I_S(1, i_Gmax);
...
%         end
%     elseif FBD == 0
%          if G_max < abs(G_S(1, i_Gmax))^2
%             G_max = abs(G_S(1, i_Gmax))^2;
%             t_max0 = t_array (1,i_Gmax);
%         end
%     end
% end
