function Simulation_FBD_Beam_GUI_14_02_2017
...
%% functions
    ...
    function Beam_3D_Reflectivity(source,eventdata)
        ...
        if get(h.Bragg_Check,'Value') ==1 ||  get(h.Bragg_FBD_Check,'Value') == 1
            [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,t_array,k_array] = Bragg_temp_Gui_14022017(Z,a_Par,b_Par,c_Par,Energy_center,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,get(h.Bragg_FBD_Check,'Value'));
            set(h.Chi_0,'String',Chi_0_Cx)
            set(h.Chi_h,'String',Chi_h_Cx)
            set(h.Theta_view,'String',Theta_Bragg*180/pi)
        ...
        elseif get(h.Laue_FBD_Check,'Value')  == 1 || get(h.Laue_Check,'Value') == 1
            [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,t_array,k_array] = Laue_temp_Gui_14022017(Z,a_Par,b_Par,c_Par,Energy_center,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,get(h.Laue_FBD_Check,'Value'));
            set(h.Chi_0,'String',Chi_0_Cx)
            set(h.Chi_h,'String',Chi_h_Cx)
            set(h.Theta_view,'String',Theta_Bragg*180/pi)
...
%                 plot(ky_transvers_array,Gaussian_ky) 
            ...
            for i_steps = 1: number_Steps
                ...
                if get(h.Mono_Beam_Check,'Value') == 1
                    ...
                    [Theta_Bragg_Mono,Chi_0_Cx_Mono,Chi_h_Cx_Mono,R_0H_S_Mono,E_Scan,t_array,k_array] = Bragg_temp_Gui_14022017(Z_Mono,a_Par_Mono,b_Par_Mono,c_Par_Mono,Energy_Bragg,Energy_center,h_Miller_Mono,k_Miller_Mono,l_Miller_Mono,DWF,f_0_Mono,f_1_Mono,f_2_Mono,absor,Range_E_neg,Range_E_pos,Polarization,Thickness_Mono,N_Step,0);
                ...
                elseif get(h.Gaussian_Beam_2D_Check,'Value') == 1                    
                    ...
                    if get(h.Bragg_Check,'Value') ==1 || get(h.Bragg_FBD_Check,'Value') == 1                        
                        [R_S_2D] = Bragg_temp_Gui_2D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array);
                        LaueD = 0;
                        
                    elseif get(h.Laue_Check,'Value') ==1 || get(h.Laue_FBD_Check,'Value') == 1
                        [R_S_2D] = Laue_temp_Gui_2D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array);                                                
                        LaueD = 1;
                ...
                elseif get(h.Gaussian_Beam_3D_Check,'Value') == 1
                   ...
                   if get(h.Mono_Beam_Check,'Value') == 0
                    ...
                    %Calculate the Green function using Kx and K
                    if get(h.Bragg_Check,'Value') ==1 || get(h.Bragg_FBD_Check,'Value') == 1                        
                        [R_S_3D] = Bragg_temp_Gui_3D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array);
                        LaueD = 0;
                        
                    elseif get(h.Laue_Check,'Value') ==1 || get(h.Laue_FBD_Check,'Value') == 1
                        [R_S_3D] = Laue_temp_Gui_3D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array);
                        LaueD = 1;
