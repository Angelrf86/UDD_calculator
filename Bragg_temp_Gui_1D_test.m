function [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_0H_S,R_00_S,E_Scan_plot,G_00,G_0H,t_array,t_max0,x_transvers_array,X_max0] = Bragg_temp_Gui_1D_test(Z,a_Par,b_Par,c_Par,Energy_Bragg,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,crystal_orientation)
%%% Calculations
% Constants
...
%Wave Length Bragg
WaveL_Bragg = h_planck*c_light/Energy_Bragg.^2; %m
...
R_0H_S = R2.*R1.*(expX2-expX1)./(R2.*expX2-R1.*expX1);
R_00_S = expX2.*expX1.*(R2-R1)./(expX2.*R2-expX1.*R1) ;
