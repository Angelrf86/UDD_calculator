...
function [R_S_3D] = Bragg_temp_Gui_3D(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,ky_array,kx_array,crystal_orientation)
%%% Calculations
% Constants
