function Simulation_FBD_Beam_GUI_par_14_02_2017
...
h.a_parameter = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.15 0.8 0.05 0.1],...
    'String','3.568',...
    'FontSize',8);
h.name_b_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.2 0.8 0.04 0.1],...
    'String','b (A)',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
h.b_parameter = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.24 0.8 0.05 0.1],...
    'String','3.568',...
    'FontSize',8);
h.name_c_Parameter = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.29 0.8 0.04 0.1],...
    'String','c (A)',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
...
h.f_check_values =uicontrol('Parent',h.lp_fit,...
    ...
    'Value', 0,...
    'FontName','Helvetica',...
    'String','Use other values for f',...
    'FontSize',6,...
    'BackgroundColor',[0.45 0.45 0.45],...
    'HorizontalAlignment','center',...
    'Callback',@Bragg_Fit_Check,...
    'Units','Normalized',...
    'Position', [0.81 0.8 0.16 0.1],...
    'FontSize',8);

h.name_f0 = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.6 0.7 0.03 0.1],...
    'String',' f0 ',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
h.f0 = uicontrol('Parent',h.lp_fit,...
    ...
    'Units','normalized',...
    'Enable','off',...
    'Position',[0.63 0.7 0.07 0.1],...
    'String','1.6077',...
    'FontSize',8);
h.name_f1 = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.7 0.7 0.03 0.1],...
    'String',' f ` ',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
h.f1 = uicontrol('Parent',h.lp_fit,...
    ...
    'Units','normalized',...
    'Enable','off',...
    'Position',[0.73 0.7 0.07 0.1],...
    'String','0.013087',...
    'FontSize',8);
h.name_f2 = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.8 0.7 0.03 0.1],...
    'String',' f " ',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
...
h.Mono_Beam_Check =  uicontrol('Parent',h.lp_fit,...
    ...
    'Callback',@Beam_3D_plot,...
    'Units','Normalized',...
    'Position', [0.32 0.35 0.09 0.1]);

h.nameElement_Mono =uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.41 0.35 0.08 0.1],...
    'BackgroundColor',[0.45 0.45 0.45],...
    'String','Element',...
    'FontSize',6);
...
h.H_Mono =uicontrol('Parent',h.lp_fit,...
    ...
    'Units','normalized',...
    'Enable', 'on',...
    'Position',[0.35 0.25 0.033 0.1],...
    'String','3',...
    'FontSize',8);
h.name_K_Mono =uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.383 0.25 0.04 0.1],...
    'BackgroundColor',[0.45 0.45 0.45],...
    'String','k',...
    'FontSize',6);
h.K_Mono =uicontrol('Parent',h.lp_fit,...
    ...
    'Units','normalized',...
    'Enable', 'on',...
    'Position',[0.423 0.25 0.033 0.1],...
    'String','1',...
    'FontSize',8);
h.name_L_Mono =uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.456 0.25 0.04 0.1],...
    'BackgroundColor',[0.45 0.45 0.45],...
    'String','l',...
    'FontSize',6);
...
h.f0_Mono = uicontrol('Parent',h.lp_fit,...
    ...
    'Units','normalized',...
    'Enable','off',...
    'Position',[0.55 0.35 0.07 0.1],...
    'String','1.6077',...
    'FontSize',8);
h.name_f1 = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.525 0.25 0.025 0.1],...
    'String',' f ` ',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
h.f1_Mono = uicontrol('Parent',h.lp_fit,...
    ...
    'Units','normalized',...
    'Enable','off',...
    'Position',[0.55 0.25 0.07 0.1],...
    'String','0.013087',...
    'FontSize',8);
h.name_f2 = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.525 0.15 0.025 0.1],...
    'String',' f " ',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',8);
...
h.Mono_Scan_Check =  uicontrol('Parent',h.lp_fit,...
    ...
    'Callback',@Beam_3D_plot,...
    'Units','Normalized',...
    'Position', [0.625 0.45 0.12 0.1]);

h.name_Range_pos_Mono = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.625 0.35 0.04 0.1],...
    'String','Range +',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',6);
h.Range_pos_Mono = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.665 0.35 0.08 0.1],...
    'String','10',...
    'FontSize',8);
h.name_Range_neg_Mono = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.625 0.25 0.04 0.1],...
    'String','Range -',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',6);
h.Range_neg_Mono = uicontrol('Parent',h.lp_fit,...
    'Style','Edit',...
    'Units','normalized',...
    'Position',[0.665 0.25 0.08 0.1],...
    'String','10',...
    'FontSize',8);
h.name_Steps_Mono = uicontrol('Parent',h.lp_fit,...
    'Style','text',...
    'Units','normalized',...
    'Position',[0.625 0.15 0.04 0.1],...
    'String','Steps',...
    'BackgroundColor',[0.45 0.45 0.45],...
    'FontSize',6);
...
%% functions
    ...
    function Dynamical_Reflectivity(source,evendata)
        ...
        elseif source == h.Dynamical_Reflectivity
            ...
            Range_E_neg = eval(get(h.Range_Left,'String'));
    ...
    function Beam_3D_plot (source,eventata)
        ...
        if source == h.Beam_simulation_Plots
            ...
            set(h.I_Fig_3D_Reflectivity_Dynamical,'Name','Dynamical reflectivity Beam',...
                ...
                'visible','on',...
                'Units','normalized',...
                'Position', [0.51 0.05 0.48 0.75],...
                'Color',[0.8 0.8 0.8],...
                'Menubar','figure',...
                'KeyReleaseFcn',@Press);
            
            h.I_Fig_Beam_3D_In = axes('Parent',h.I_Fig_3D_Reflectivity_Dynamical, 'Units','normalized',...
                'Position',[0.57 0.65 0.4 0.25],...
                'box','on',...
                'LineWidth',0.5,...
                'fontsize',8,...
                'box','on',...
            ...
            h.I_Fig_Beam_2_3D_In = axes('Parent',h.I_Fig_3D_Reflectivity_Dynamical, 'Units','normalized',...
                'Position',[0.57 0.32 0.4 0.25],...
                'box','on',...
                'LineWidth',0.5,...
                'fontsize',8,...
                'box','on',...
            ...
            h.I_Fig_Beam_Reciprocal_3D_In = axes('Parent',h.I_Fig_3D_Reflectivity_Dynamical, 'Units','normalized',...
                'Position',[0.07 0.65 0.4 0.25],...
                'box','on',...
                'LineWidth',0.5,...
                'fontsize',8,...
                'box','on',...
            ...
            h.I_Fig_Beam_Reciprocal2_3D_In= axes('Parent',h.I_Fig_3D_Reflectivity_Dynamical, 'Units','normalized',...
                'Position',[0.07 0.32 0.4 0.25],...
                'box','on',...
                'LineWidth',0.5,...
                'fontsize',8,...
                'box','on',...
            ...
            h.I_Fig_Beam_3D_R_In = axes('Parent',h.I_Fig_3D_Reflectivity_Dynamical, 'Units','normalized',...
                'Position',[0.07 0.05 0.4 0.2],...
                'box','on',...
                'LineWidth',0.5,...
                'fontsize',8,...
                'box','on',...
            ...
            h.I_Fig_Beam_3D_Int_In = axes('Parent',h.I_Fig_3D_Reflectivity_Dynamical, 'Units','normalized',...
                'Position',[0.57 0.05 0.4 0.2],...
                'box','on',...
                'LineWidth',0.5,...
                'fontsize',8,...
                'box','on',...
        ...
        if source == h.Load_Energy_point
            ...
            elseif get(h.Gaussian_Beam_2D_Check,'value') == 1               
                ...
                elseif h.BX ==4
                    ...
                    view([90 0]);
                    zlabel('Intensity (arb units)')
                    xlabel('Transverse displecement (um)')
                    ylabel('Energy (eV)')
    ...
    function Beam_3D_plot_Save(source,eventdata)
        ...
        if source == h.Save_Energy_point
            ...
            Name_common = sprintf('%s%s%s%s_%0.1dKeV_%0.1dum_%s',Element,Miller,FBD,Bragg,Energy_center,Thickness,Mono);
            ...
            elseif get(h.Gaussian_Beam_2D_Check,'value') == 1               
                ...
                if h.BX == 1    
                    Name_File = sprintf('%s_f1_xt_I%0.4d.mat',Name_File,Image_point);
                ...
                elseif h.BX == 2     
                    ...
                    Name_File = sprintf('%s_f2_xt_I%0.4d.mat',Name_File,Image_point);
                    filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                    
                    save(filename_Output,'t_array','x_array','Gaussian_R');     
                                        
                elseif h.BX == 3   
                    Name_File = sprintf('%s_f3_xt_I%0.4d.mat',Name_File,Image_point);
                    filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
            ...
            elseif get(h.Gaussian_Beam_3D_Check,'value') == 1
                ...
                if h.BX == 1                        
                    ...
                    elseif t_plot == 1 && y_plot == 1
                        Name_File = sprintf('%s_f1_yt_I%0.4d.mat',Name_File,Image_point);
                        filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                        R_S_G_sum(:,:) = sum(abs(R_S_G).^2,2);
                    ...
                    elseif (y_plot) == 1 && (x_plot == 1)
                        Name_File = sprintf('%s_f1_xy_I%0.4d.mat',Name_File,Image_point);
                        filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                        R_S_G_sum(:,:) = sum(abs(R_S_G).^2,3);
                ...
                elseif h.BX == 2                              
                    ...
                    elseif t_plot == 1 && y_plot == 1
                        Name_File = sprintf('%s_f2_yt_I%0.4d.mat',Name_File,Image_point);
                        filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                        Gaussian_R_sum(:,:) = sum(abs(Gaussian_R).^2,2);
                    ...
                    elseif x_plot == 1 && y_plot == 1
                        Name_File = sprintf('%s_f2_xy_I%0.4d.mat',Name_File,Image_point);
                        filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                        Gaussian_R_sum(:,:) = sum(abs(Gaussian_R).^2,3);
                ...
                elseif h.BX == 3    
                    ...
                    elseif t_plot == 1 && x_plot == 1                        
                        Name_File = sprintf('%s_f3_yt_I%0.4d.mat',Name_File,Image_point);
                        filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                        R_S_2D_sum(:,:) = sum(abs(R_S_2D).^2,2);                        
                    ...
                    elseif t_plot == 1 && x_plot == 1                        
                        Name_File = sprintf('%s_f3_xy_I%0.4d.mat',Name_File,Image_point);
                        filename_Output = sprintf('%s/%s',directoryname_Images,Name_File); 
                        R_S_2D_sum(:,:) = sum(abs(R_S_2D).^2,3);
    ...
    function Beam_3D_Reflectivity(source,eventdata)
        ...
        child = get(h.I_Fig_Beam_3D_In,'Children');
        for i=1:length(child)
            delete(child(i));
        end
        
        child = get(h.I_Fig_Beam_3D_R_In,'Children');
        for i=1:length(child)
            delete(child(i));
        end
        child = get(h.I_Fig_Beam_3D_Int_In,'Children');
        for i=1:length(child)
            delete(child(i));
        end
        
        child = get(h.I_Fig_Beam_Reciprocal_3D_In,'Children');
        for i=1:length(child)
            delete(child(i));
        end
        child = get(h.I_Fig_Beam_Reciprocal2_3D_In,'Children');
        for i=1:length(child)
            delete(child(i));
        end
        child = get(h.I_Fig_Beam_2_3D_In,'Children');
        for i=1:length(child)
            delete(child(i));
        end
        ...
        if get(h.Bragg_Check,'Value') ==1 ||  get(h.Bragg_FBD_Check,'Value') == 1
            [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,t_array,k_array] = Bragg_temp_Gui_par_14022017(Z,a_Par,b_Par,c_Par,Energy_center,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,get(h.Bragg_FBD_Check,'Value'));
            set(h.Chi_0,'String',Chi_0_Cx)
            set(h.Chi_h,'String',Chi_h_Cx)
            set(h.Theta_view,'String',Theta_Bragg*180/pi)
        ...
        elseif get(h.Laue_FBD_Check,'Value')  == 1 || get(h.Laue_Check,'Value') == 1
            [Theta_Bragg,Chi_0_Cx,Chi_h_Cx,R_S,E_Scan,t_array,k_array] = Laue_temp_Gui_par_14022017(Z,a_Par,b_Par,c_Par,Energy_center,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,get(h.Laue_FBD_Check,'Value'));
            set(h.Chi_0,'String',Chi_0_Cx)
            set(h.Chi_h,'String',Chi_h_Cx)
            set(h.Theta_view,'String',Theta_Bragg*180/pi)
        ...
        axes(h.I_Fig_Beam_3D_R_In)        
        plot(E_Scan_plot,abs(R_S).^2,'Parent',h.I_Fig_Beam_3D_R_In,'Color','r')
        ...
        if  source == h.Beam_simulation            
            ...
            if get(h.Gaussian_Beam_2D_Check,'Value') == 1
                %Definition of x
                ...
                x_array = linspace(1,initial_range_x,N_Step_x)*1e-6;
                
                Gaussian_x = 1*exp(-((x_array-initial_range_x/2*1e-6)/sigma_x).^2./2);
                % axes(h.I_Fig_Beam_3D_Int_In)  
%                 figure
...
%               
                ...
                y_array = linspace(1,initial_range_y,N_Step_y)*1e-6;
                Gaussian_y = 1*exp(-((y_array-initial_range_y/2*1e-6)/sigma_y).^2./2);                
...
%                 plot(ky_transvers_array,Gaussian_ky) 
            ...
            for i_steps = 1: number_Steps
                ...
                if get(h.Mono_Beam_Check,'Value') == 1
                    ...
                    [Theta_Bragg_Mono,Chi_0_Cx_Mono,Chi_h_Cx_Mono,R_0H_S_Mono,E_Scan,t_array,k_array] = Bragg_temp_Gui_par_14022017(Z_Mono,a_Par_Mono,b_Par_Mono,c_Par_Mono,Energy_Bragg,Energy_center,h_Miller_Mono,k_Miller_Mono,l_Miller_Mono,DWF,f_0_Mono,f_1_Mono,f_2_Mono,absor,Range_E_neg,Range_E_pos,Polarization,Thickness_Mono,N_Step,0);
                    
                    axes(h.I_Fig_Beam_3D_R_In)
                    plot(E_Scan,abs(R_0H_S_Mono).^2,'Parent',h.I_Fig_Beam_3D_R_In)
                    ...
                    R_0H_S_Mono_all(i_steps,:) = R_0H_S_Mono;
                ...
                if get(h.Gaussian_Beam_1D_Check,'Value') == 1
                    ...
                    if get(h.Mono_Beam_Check,'Value') == 0
                        ...
                        plot(E_Scan_plot,abs(Gaussian_k).^2,'Parent',h.I_Fig_Beam_3D_R_In)
                        
                        % To time space
                        Gaussian_T = ifft(fftshift(Gaussian_k));
                        plot(t_array,Gaussian_T,'Parent',h.I_Fig_Beam_3D_In)
                        pause(1)
                        ...
                        plot(t_array,abs(Gaussian_T).^2,'Parent',h.I_Fig_Beam_3D_In)
                        pause(1)
                        ...
                        R_S_G = R_S.*R_0H_S_Mono;
                        
                    end
                    
                    axes(h.I_Fig_Beam_Reciprocal_3D_In)                    
                    plot(E_Scan_plot,abs(R_S_G).^2,'Parent',h.I_Fig_Beam_Reciprocal_3D_In)
                    
                    set(h.I_Fig_Beam_Reciprocal_3D_In,'yscale','linear');
                    ...
                    elseif get(h.Bragg_FBD_Check,'Value')==1 || get(h.Laue_FBD_Check,'Value')==1    
                        Gaussian_R = (ifft(R_00_S_G));
                    end
                    
                    Intensity_array(1,i_steps) = sum(abs(Gaussian_R).^2);
                    
                    axes(h.I_Fig_Beam_3D_In)                       
                    plot(t_array,abs(Gaussian_R).^2,'Parent',h.I_Fig_Beam_3D_In)
                    set(h.I_Fig_Beam_3D_In,'yscale','log');
                    xlabel('Time (s)')
                    ...
                    title(title_Convolution)
                    ylabel('Intensity (arb units)')
                    %xlim([xlim_neg xlim_pos])
                    
                    axes(h.I_Fig_Beam_3D_Int_In)                       
                    plot(Energy_array(1,i_steps),Intensity_array(1,i_steps),'Parent',h.I_Fig_Beam_3D_Int_In,'LineStyle','none','Marker','o','MarkerFaceColor','r','MarkerEdgeColor','r');
                    title_Convolution = strcat('Monochromator(',get(h.H_Mono,'String'),',',get(h.K_Mono,'String'),',',get(h.L_Mono,'String'),') Convoluted with (',h_Miller,',',k_Miller,',',l_Miller,')');
                    title(title_Convolution)
                    ylabel('Intensity (arb units)')
                    xlabel('Energy (eV)')
                ...
                elseif get(h.Gaussian_Beam_2D_Check,'Value') == 1                    
                    ...
                    if get(h.Mono_Beam_Check,'Value') == 0
                        ...
                        %Back to k space
                        G_mono=fftshift(fft(Gaussian_T));
                        
                        plot(E_Scan_plot,abs(G_mono).^2,'Parent',h.I_Fig_Beam_3D_R_In)
                    ...
                    axes(h.I_Fig_Beam_Reciprocal_3D_In)                                        
                    surf(E_Scan_plot,kx_transvers_array,abs(Gaussian_K).^2,'Parent',h.I_Fig_Beam_Reciprocal_3D_In,'edgecolor','none')
                    view([20 20]);                    
                    ...
                    if get(h.Bragg_Check,'Value') ==1 || get(h.Bragg_FBD_Check,'Value') == 1                        
                        [R_S_2D] = Bragg_temp_Gui_par_2D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array);
                        LaueD = 0;
                        
                    elseif get(h.Laue_Check,'Value') ==1 || get(h.Laue_FBD_Check,'Value') == 1
                        [R_S_2D] = Laue_temp_Gui_par_2D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array);                                                
                        LaueD = 1;
                        
                    end
                    
                    axes(h.I_Fig_Beam_Reciprocal2_3D_In)    
                    if get(h.Bragg_Check,'Value') ==1 ||   get(h.Laue_Check,'Value') ==1
                        surf(E_Scan_plot,kx_transvers_array,abs(R_S_2D).^2,'Parent',h.I_Fig_Beam_Reciprocal2_3D_In,'edgecolor','none')
                        view([20 20]);
                    elseif get(h.Bragg_FBD_Check,'Value') == 1 || get(h.Laue_FBD_Check,'Value') == 1
                        surf(E_Scan_plot,kx_transvers_array,abs(R_00_S_2D).^2,'Parent',h.I_Fig_Beam_Reciprocal2_3D_In,'edgecolor','none')
                        view([20 20]);
                    end
                    ...
                    R_S_all(:,:,i_steps) = R_S_2D;
                    R_S_2D = [];
                    
                    Gaussian_K = [];
                    
                    axes(h.I_Fig_Beam_Reciprocal_3D_In)   
                    surf(E_Scan_plot,kx_transvers_array,abs(R_S_G).^2,'Parent',h.I_Fig_Beam_Reciprocal_3D_In,'edgecolor','none')
                    view([20 20]);                    
                                        
                    Gaussian_R = fftshift((ifft2(R_S_G)),2);
                    ...
                    axes(h.I_Fig_Beam_3D_In)                           
                    surf(t_array,x_array,abs(Gaussian_R).^2,'Parent',h.I_Fig_Beam_3D_In,'edgecolor','none')
                    view([90 0]);
                    
                    axes(h.I_Fig_Beam_2_3D_In)
                    Intensityx_array(i_steps,:) = sum(abs(Gaussian_R).^2,2);
                    plot(x_array',Intensityx_array(i_steps,:),'Parent',h.I_Fig_Beam_2_3D_In)
                    hold on
                    ...
                    Gaussian_R_all(:,:,i_steps) = Gaussian_R;
                    % Free Space
                    Gaussian_R = [];
                ...
                elseif get(h.Gaussian_Beam_3D_Check,'Value') == 1
                   ...
                   if get(h.Mono_Beam_Check,'Value') == 0
                    ...
                    surf(ky_transvers_array,kx_transvers_array,abs(Gaussian_XY).^2,'Parent',h.I_Fig_Beam_Reciprocal_3D_In,'edgecolor','none')

                    for i_x = 1 :size(E_Scan_plot,2)                        
                            Gaussian_K (:,:,i_x)= Gaussian_XY'.*G_mono(1,i_x);                        
                    end
                    

                    axes(h.I_Fig_Beam_Reciprocal_3D_In)
                    plot_G(:,:) = Gaussian_K(:,:,N_Step/2);
                    size(plot_G)
                    size(kx_transvers_array)
                    surf(kx_transvers_array,ky_transvers_array,abs(plot_G).^2,'Parent',h.I_Fig_Beam_Reciprocal_3D_In,'edgecolor','none')
                    view([20 20]);
                    ...
                    %Calculate the Green function using Kx and K
                    if get(h.Bragg_Check,'Value') ==1 || get(h.Bragg_FBD_Check,'Value') == 1                        
                        [R_S_3D] = Bragg_temp_Gui_par_3D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array);
                        LaueD = 0;
                        
                    elseif get(h.Laue_Check,'Value') ==1 || get(h.Laue_FBD_Check,'Value') == 1
                        [R_S_3D] = Laue_temp_Gui_par_3D_14022017(Z,a_Par,b_Par,c_Par,Energy_Bragg,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array);
                        LaueD = 1;
                    ...
                    surf(kx_transvers_array,ky_transvers_array,abs(R_S_3D(:,:,N_Step/2)).^2,'Parent',h.I_Fig_Beam_Reciprocal2_3D_In,'edgecolor','none')
                    view([20 20]);
                    ...
                    % Convolute both signals R MONO and R crystal in 2D
                    R_S_G = R_S_3D.*Gaussian_K;

                    R_S_all(:,:,:,i_steps) = R_S_3D;
                    R_S_3D = [];
                    ...
                    axes(h.I_Fig_Beam_Reciprocal_3D_In)   
                    surf(kx_transvers_array,ky_transvers_array,abs(R_S_G(:,:,N_Step/2)).^2,'Parent',h.I_Fig_Beam_Reciprocal_3D_In,'edgecolor','none')
                    view([20 20]);                    
                    ...
                    axes(h.I_Fig_Beam_3D_In)                           
                    surf(x_array,y_array,abs(Gaussian_R(:,:,N_Step/2)).^2,'Parent',h.I_Fig_Beam_3D_In,'edgecolor','none')
                    view([90 0]);
                    
                    axes(h.I_Fig_Beam_2_3D_In)
                    Intensityx_array(i_steps,:) = sum(sum(abs(Gaussian_R).^2,1),3);
                    plot(x_array',Intensityx_array(i_steps,:),'Parent',h.I_Fig_Beam_2_3D_In)
                    hold on
            ...
            if get(h.Mono_Scan_Check,'value') == 1
                if get(h.Gaussian_Beam_1D_Check,'Value') == 1
                    axes(h.I_Fig_Beam_3D_Int_In)
                    plot(Energy_array,Intensity_array,'Parent',h.I_Fig_Beam_3D_Int_In,'LineStyle','-','Marker','o','MarkerFaceColor','r','MarkerEdgeColor','r');
                    title_Convolution = strcat('Monochromator(',get(h.H_Mono,'String'),',',get(h.K_Mono,'String'),',',get(h.L_Mono,'String'),') Convoluted with (',num2str(h_Miller),',',num2str(k_Miller),',',num2str(l_Miller),')');
                    title(title_Convolution)
                    ylabel('Intensity (arb units)')
                    xlabel('Energy (eV)')
                ...
                elseif get(h.Gaussian_Beam_2D_Check,'Value') == 1
                    ...
                    axes(h.I_Fig_Beam_2_3D_In)
                    hold off
                    surf(x_array,Energy_array,Intensityx_array,'Parent',h.I_Fig_Beam_2_3D_In,'edgecolor','none')
                    zlabel('Intensity (arb units)')
                    xlabel('Transverse displecement (um)')
                    ylabel('Energy (eV)')
                    axis auto
