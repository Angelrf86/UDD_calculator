function Simulation_FBD_Beam_GUI_test2
    ...
    function Beam_3D_plot (source,eventata)
        ...
        if source == h.Beam_simulation_Plots
            ...
            h.directoryname_Images= uicontrol('Parent',h.I_Fig_3D_Reflectivity_Dynamical,...
                ...
                'Enable','on',...
                'FontName','Helvetica',...
                'String','/das/work/p15/p15366/RN84/SwissFEL Simulation/',...
                'FontWeight','bold',...
                'HorizontalAlignment','center',...
                'Units','Normalized',...
                ...
                if get(h.More_Crystal_Chk,'value') == 1
                    ...
                    for i_cryst = 1:size(pos_MCC,2)
                        ...
                        elseif pos_MCC(1,i_cryst) == 2                             
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D2] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D2] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 3                            
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D3] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D3] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                         ...
                         elseif pos_MCC(1,i_cryst) == 4
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D4] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                               
                            else
                                [R_S_3D4] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                           ...
                           elseif pos_MCC(1,i_cryst) == 5
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D5] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D5] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 6
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D6] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D6] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 7
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D7] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D7] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                        ...
                        elseif pos_MCC(1,i_cryst) == 8
                            if Geometry_MCC(1,i_cryst) ==1 
                                [R_S_3D8] = Bragg_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                                
                            else
                                [R_S_3D8] = Laue_temp_Gui_3D_test2(Z,a_Par(1,i_cryst),b_Par(1,i_cryst),c_Par(1,i_cryst),Energy_center,Energy_center+Energy_MCC(1,i_cryst),h_MCC(1,i_cryst),k_MCC(1,i_cryst),l_MCC(1,i_cryst),DWF,f_0(1,i_cryst),f_1(1,i_cryst),f_2(1,i_cryst),absor,Range_E_neg,Range_E_pos,polarization,Asymmetry_MCC(1,i_cryst),Thickness_MCC(1,i_cryst),N_Step,Transmission_MCC(1,i_cryst),kx_transvers_array,ky_transvers_array,Normal_MCC(1,i_cryst));
                    ...
                    %Calculate the Green function using Kx and K
                    if get(h.Bragg_Check,'Value') ==1 || get(h.Bragg_FBD_Check,'Value') == 1                        
                        [R_S_3D1] = Bragg_temp_Gui_3D_test(Z,a_Par,b_Par,c_Par,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array,crystal_orientation);
                        LaueD = 0;
                        
                    elseif get(h.Laue_Check,'Value') ==1 || get(h.Laue_FBD_Check,'Value') == 1
                        [R_S_3D1] = Laue_temp_Gui_3D_test(Z,a_Par,b_Par,c_Par,Energy_center,h_Miller,k_Miller,l_Miller,DWF,f_0,f_1,f_2,absor,Range_E_neg,Range_E_pos,Polarization,Ang_asy_Deg,Thickness,N_Step,FBD,kx_transvers_array,ky_transvers_array,crystal_orientation);
                        LaueD = 1;
